...
#property copyright "Rythmn Renko"
#property link      ""
...
#import
//+------------------------------------------------------------------+
extern double  StartingPrice     = 0;

extern double  RenkoBoxSize1     = 5.0;
extern double  BoxShiftPercent1  = 25;
...
extern double  BoxShiftPercent2  = 25;
...
if (!Use2ndRenkoChart)
   {Comment("Rythmn X Shift Renko (" +DoubleToStr(RenkoBoxSize1,1)+ ") point: Open Offline ", SymbolName, ",M", RenkoTimeFrame1, " to view chart");}
if (Use2ndRenkoChart)
   {
 //DRUGI-----------------------------------------------------------------------------------------
	...
	FileSeek(HstHandle2, LastFPos2, SEEK_SET);
 	...
 	//-------------------------------------------------------------------------	   				
      ...
      CurOpen2 = PrevClose2;
		...
		Comment("R Y T H M Renko (" + DoubleToStr(RenkoBoxSize1,1) + ") point: Open Offline ", SymbolName, ",M", RenkoTimeFrame1, " to view chart","\n",
		        "R Y T H M Renko (" + DoubleToStr(RenkoBoxSize2,1) + ") point: Open Offline ", SymbolName, ",M", RenkoTimeFrame2, " to view chart");
